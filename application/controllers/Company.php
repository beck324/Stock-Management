...
class Company extends Admin_Controller 
{
    ...
    */
	...
	{  
		...
		$this->form_validation->set_rules('service_charge_value', 'Product Vat', 'trim|integer');
		$this->form_validation->set_rules('vat_charge_value', 'Service Vat', 'trim|integer');
        ...
        if ($this->form_validation->run() == TRUE) {
        	...
        	$data = array(
        		...
        		'service_vat' => $this->input->post('service_charge_value'),
        		'product_vat' => $this->input->post('vat_charge_value'),
