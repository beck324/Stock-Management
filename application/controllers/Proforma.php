...
class Orders extends Admin_Controller 
{
	...
	*/
	public function index()
	{
		...
		$this->data['page_title'] = 'Manage Proforma';
		$this->render_template('proformas/index', $this->data);		
	}
	...
	*/
	public function create()
	{
		...
		$this->data['page_title'] = 'Add Proforma';
...
function convertNumberToWord($num = false)
{
	...
	public function printDiv($id)
	{
		...
		if($id) {
			...
			<h1>Cash Sales Attachment</h1><br>
			          			        
			          <tr><th></th><th></th></tr>
			          <tr><th><font color="green">Company</font></th><td>'.$company_info['company_name'].'</td></tr>
			          <tr><th><font color="green">Proforma No</font></th><td>'.$order_data['bill_no'].'</td></tr>
			           <tr><th><font color="green">Date</font></th><td>'.$order_date.'</td></tr>
			          </table></b>
			          </small>
			          </div>
			</div>
  ...
  <div class="row" style="width: 56%">
    <h3><font color="green">FROM</font></h3><hr color="green" style=" margin-right:400px;border-color:green">
...
Addis Ababa, Ethiopia</pre>
  ...
  <div class="row" style="width: 34%">
    <h3><font color="green">TO</font></h3><hr  style=" border-color: green" ></hr>
              ...
              <b><font color="green">Bill ID:</font></b> '.$order_data['bill_no'].'<br>
			      ...
			      <div class="col-xs-12 table-responsive">
			        <table border="1px" bordercolor="white"  class="table table-striped"  ">
			          ...
			          foreach ($orders_items as $k => $v) {
			          	...
			          	<td style="color:gray;background-color:#F1F1F3 !important;">'.$product_data['description'].'</td><td style="background-color:#F1F1F1 !important;"></td><td style="background-color:#F1F1F1 !important;"></td><td style="background-color:#F1F1F1 !important;"></td>
