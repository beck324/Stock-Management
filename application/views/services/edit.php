        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="product_name">Services name</label>
                  <input type="text" class="form-control" id="product_name" name="service_name" placeholder="Enter Services name" value="<?php echo $product_data['name']; ?>"  autocomplete="off"/>
                </div>
