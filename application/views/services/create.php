        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('users/create') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="sku">Service Id</label>
                  <input type="text" class="form-control" id="sku" name="sku" placeholder="Enter service id" autocomplete="off" />
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('services/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
