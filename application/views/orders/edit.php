          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <?php endif; ?>
                  <?php if($product_vat == true): ?>
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">Product Vat <?php echo $company_data['product_vat'] ?> %</label>
                    <div class="col-sm-7">
              ...
              <div class="box-footer">
                ...
                <input type="hidden" name="vat_charge_rate" value="<?php echo $company_data['product_vat'] ?>" autocomplete="off">
...
<script type="text/javascript">
  ...
  function subAmount() {
    ...
    var vat_charge = <?php echo ($company_data['product_vat'] > 0) ? $company_data['product_vat']:0; ?>;
    ...
    // vat
     if (Number($("#gross_amount").val()) > 10000 && selectedValue == "1")
   {
